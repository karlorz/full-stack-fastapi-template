...
*/}}
{{- define "service-account.fullname" -}}
...
{{ merge (.Values.global.labels | default (dict)) (fromYaml (include "service-account.selectorLabels" .) ) | toYaml }}
{{- if .Values.global.helmLabels }}
